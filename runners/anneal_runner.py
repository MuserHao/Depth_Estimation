...
class AnnealRunner():
    ...
    def train(self):
        ...
        dataloader = DataLoader(dataset, batch_size=self.config.training.batch_size, shuffle=True, num_workers=0) # changed num_workers from 4 to 0
    ...
    def test_inpainting(self):
        ...
        if self.config.data.dataset == 'CELEBA':
            ...
            dataloader = DataLoader(dataset, batch_size=20, shuffle=True, num_workers=0)   # changed num_workers from 4 to 0
